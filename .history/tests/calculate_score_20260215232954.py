...
def get_sonar_metrics():
    ...
    # 1. Probeer de specifieke Task ID van de huidige run te vinden
    task_id = None
    ...
    # 2. Als we een Task ID hebben, wacht tot deze op SUCCESS staat
    if task_id:
        for _ in range(10): # Max 10 pogingen (50 seconden extra)
    ...
    # 3. Haal nu de metrics op (nu weten we dat ze vers zijn)
    ...
    try:
        ...
        # Als coverage nog steeds 0 is, is er echt iets mis met de scan zelf
        ...
        return 20.0, f"Sonar API Error: {str(e)}"
